...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:add.html.twig', 'FooBundle:Post:add.html.twig', '@FooBundle/Resources/views/Post/add.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
